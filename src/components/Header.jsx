...
const Header = ({ isEditable, setIsEditable }) => {
  return (
    <header className="fixed top-0 left-0 w-full flex justify-between items-center py-3 px-4 sm:py-4 sm:px-6 bg-white shadow-md z-50 border-b border-gray-100 no-print">
